...
(function() {
  ...
  iOSAppBundleInfo = (function(superClass) {
    ...
    iOSAppBundleInfo.prototype.getIconFile = function(iconFileName, callback) {
      if (iconFileName == null) {
        iconFileName = 'AppIcon60x60@*.png';
      }
      return this.findFileStream("Payload/*.app/" + iconFileName, function(err, stream) {
        if (err) {
          return callback(err);
        }
        if (!stream) {
